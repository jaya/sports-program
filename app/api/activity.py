...
async def get_activities(
    ...
    return await service.find_activities(slack_id=x_slack_user_id)
...
async def get_activities_by_program(
    ...
    return await service.find_activities_by_program(program_id, x_slack_user_id)
...
async def create_activity_by_program(
    ...
    return await service.insert_activity_by_program(activity_create, program_id, x_slack_user_id)
